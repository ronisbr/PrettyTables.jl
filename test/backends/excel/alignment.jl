...
@testset "Alignment" verbose=true begin
    ...
    @test XLSX.getAlignment(f[1], "B4").alignment["alignment"] == Dict("horizontal" => "left", "wrapText" => "1", "vertical" => "top")
    @test XLSX.getAlignment(f[1], "C4").alignment["alignment"] == Dict("horizontal" => "right", "wrapText" => "1", "vertical" => "top")
    @test XLSX.getAlignment(f[1], "D4").alignment["alignment"] == Dict("horizontal" => "center", "wrapText" => "1", "vertical" => "top")
    ...
    @test XLSX.getAlignment(f[1], "A4").alignment["alignment"] == Dict("horizontal" => "right", "wrapText" => "1", "vertical" => "top")
    @test XLSX.getAlignment(f[1], "B4").alignment["alignment"] == Dict("horizontal" => "center", "wrapText" => "1", "vertical" => "top")
    @test XLSX.getAlignment(f[1], "C4").alignment["alignment"] == Dict("horizontal" => "left", "wrapText" => "1", "vertical" => "top")
