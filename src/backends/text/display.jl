...
"""
function _draw_continuation_row(display::Display, io::IO, tf::TextFormat,
...
"""
function _draw_line!(display::Display, io::IO, left::Char, intersection::Char,
...
"""
function _pc!(cond::Bool, display::Display, crayon::Crayon,
