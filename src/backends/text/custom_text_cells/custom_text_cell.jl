## Description #############################################################################
#
# Custom cells for the text back end.
#
############################################################################################
...
Crop `num` characters from the line `l` of the custom text cell `c`. The number of cropped
characters must consider the left and right alignment paddings.
"""
...
Return the printable line `l` of the custom text cell `c`. The printable cell line must
consider the left and right alignment paddings.
"""
