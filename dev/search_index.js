...
{
    "location": "lib/library/#PrettyTables._draw_continuation_row-NTuple{11,Any}",
    "page": "Library",
    "title": "PrettyTables._draw_continuation_row",
    "category": "method",
    "text": "_draw_continuation_row(screen, io, tf, text_crayon, border_crayon, num_printed_cols, cols_width, show_row_number, row_number_width, show_row_names, row_name_width)\n\nDraw the continuation row when the table has filled the vertical space available. This function prints in each column the character ⋮ centered.\n\n\n\n\n\n"
},

{
    "location": "lib/library/#PrettyTables._draw_line!-NTuple{13,Any}",
    "page": "Library",
    "title": "PrettyTables._draw_line!",
    "category": "method",
    "text": "_draw_line!(screen, io, left, intersection, right, row, border_crayon, num_cols, cols_width, show_row_number, row_number_width, show_row_names, row_name_width)\n\nDraw a vertical line in io using the information in screen.\n\n\n\n\n\n"
},
