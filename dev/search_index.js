...
{
    "location": "lib/library/#PrettyTables.Display",
    "page": "Library",
    "title": "PrettyTables.Display",
    "category": "type",
...
{
    "location": "lib/library/#PrettyTables._draw_continuation_row-Tuple{PrettyTables.Display,IO,TextFormat,Crayon,Crayon,Array{Int64,1},Array{Int64,1},Symbol}",
    "page": "Library",
    "title": "PrettyTables._draw_continuation_row",
    "category": "method",
    "text": "_draw_continuation_row(display::Display, io::IO, tf::TextFormat, text_crayon::Crayon, border_crayon::Crayon, cols_width::Vector{Int}, vlines::Vector{Int}, alignment::Symbol)\n\nDraw the continuation row when the table has filled the vertical space available. This function prints in each column the character ⋮ with the alignment in alignment.\n\n\n\n\n\n"
},

{
    "location": "lib/library/#PrettyTables._draw_line!-Tuple{PrettyTables.Display,IO,Char,Char,Char,Char,Crayon,Array{Int64,1},Array{Int64,1}}",
    "page": "Library",
    "title": "PrettyTables._draw_line!",
    "category": "method",
    "text": "_draw_line!(display::Display, io::IO, left::Char, intersection::Char, right::Char, row::Char, border_crayon::Crayon, cols_width::Vector{Int}, vlines::Vector{Int})\n\nDraw a vertical line in internal line buffer of display and then flush to the io io.\n\n\n\n\n\n"
},

{
    "location": "lib/library/#PrettyTables._eol-Tuple{PrettyTables.Display}",
    "page": "Library",
    "title": "PrettyTables._eol",
    "category": "method",
    "text": "_eol(display::Display)\n\nReturn true if the cursor is at the end of line or false otherwise.\n\n\n\n\n\n"
},
...
{
    "location": "lib/library/#PrettyTables._nl!-Tuple{PrettyTables.Display,IO}",
    "page": "Library",
    "title": "PrettyTables._nl!",
    "category": "method",
    "text": "_nl!(display::Display, io::IO)\n\nFlush the internal line buffer of display into io.\n\n\n\n\n\n"
},
