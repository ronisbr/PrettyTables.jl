...

{
    ...
    "title": "Configuration",
    "category": "section",
    "text": "The configuration used when printing the table is defined by conf. This object can be created by the function set_pt_conf in which the keyword parameters can be any one supported by the function pretty_table.note: Note\nThe configurations in conf will be overridden by kwargs... in the function pretty_table.julia> conf = set_pt_conf(tf = markdown, alignment = :c);\n\njulia> data = [1 2 3; 4 5 6];\n\njulia> header = [\"Column 1\" \"Column 2\" \"Column 3\"];\n\njulia> pretty_table(conf, data, header)\n| Column 1 | Column 2 | Column 3 |\n|----------|----------|----------|\n|    1     |    2     |    3     |\n|    4     |    5     |    6     |A configuration object can be modified by the function set_pt_conf! and cleared by the function clear_pt_conf!."
},
...

{
    ...
    "category": "section",
    "text": "The following table formats are available when using the LaTeX back-end:latex_default (Default)(Image: )latex_simple(Image: )"
},
