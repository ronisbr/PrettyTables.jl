...
{
    "location": "lib/library/#PrettyTables._str_escaped",
    "page": "Library",
    "title": "PrettyTables._str_escaped",
    "category": "function",
    "text": "_str_escaped(str::AbstractString, esc::String = \"\")\n\nReturn the escaped string representation of str. esc contains additional characters that must be also escaped.\n\n\n\n\n\n"
},

{
    ...
    "category": "function",
    "text": "_str_line_breaks(str::String, autowrap::Bool = false, width::Int = 0, esc::String = \"\")\n\nSplit the string str into substring, each one meaning one new line. If autowrap is true, then the text will be wrapped so that it fits the column with the width width. esc is a set of additional characters that will be escaped.\n\n\n\n\n\n"
},
